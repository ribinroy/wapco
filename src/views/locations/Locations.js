...
function Locations() {
    ...
    const [showDeletePop, setDeletePop] = useState(false);
    const locations = [
        {
            title: 'All',
            address: '',
    ...
    return (
        <div className={classes.location__wrapper}>
            <TopBar
                heading='Locations'
                subHeading='Select installation location'
                img={LocationImg}
                customBtn='addGateWay'
            />
            <AddLocation
                heading={'Edit Location'}
                isShown={showEditLocation}
                onClose={() => setShowEditLocation(false)}
            />
            <Pane>
                <Dialog
                    isShown={showDeletePop}
                    title='Please confirm'
                    onCloseComplete={() => setDeletePop(false)}
